...
import com.linkedin.helix.tools.ClusterStateVerifier.Verifier;
...
public class TestAutoRebalance extends ZkStandAloneCMTestBase
{
  ...
  public void beforeClass() throws Exception
  {
    ...
    boolean result =
        ClusterStateVerifier.verify(new ExternalViewBalancedVerifier(_zkClient,
  ...
  public static class ExternalViewBalancedVerifier implements Verifier
  {
    ZkClient _client;
    String _clusterName;
