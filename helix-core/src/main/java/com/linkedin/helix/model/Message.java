...
public class Message extends HelixProperty {
	...
	public InstanceType getSrcInstanceType() {
		if (_record.getSimpleFields().containsKey(Attributes.SRC_INSTANCE_TYPE.toString())) {
			return InstanceType.valueOf(_record.getSimpleField(Attributes.SRC_INSTANCE_TYPE
			        .toString()));
		}
	...
	public void setMsgState(MessageState msgState) { // HACK: The
													 // "tolowerCase()" call is
													 // to make the change
													 // backward compatible
	...
	public MessageState getMsgState() {
		// HACK: The "toUpperCase()" call is to make the change backward
		// compatible
	...
	public List<String> getPartitionNames() {
		...
		if (partitionNames == null) {
			...
			partitionNames = Arrays.asList(getPartitionName());
		}
	...
	public String getExeMsgId() {
		return getMsgId() + "/" + getExePartitionNames();
	}
	...
	public boolean isValid() {
		// TODO: refactor message to state transition message and task-message
		// and
