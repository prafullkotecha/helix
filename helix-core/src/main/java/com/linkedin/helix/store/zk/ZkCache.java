...
public class ZkCache implements IZkChildListener, IZkDataListener, IZkStateListener
{
  ...
  boolean purgeCache(String path)
  {
    try
    {
      ...
      // if a node gets purged, none of its parent nodes should be in cache
  ...
  void updateCache(String path)
  {
    try
    {
      ...
      else
      {
        ...
        changes.add(path + "-" + "updatecache3-" + "oldcid" + oldStat.getCzxid() + "-newcid" + stat.getCzxid());
      ...
      changes.add(path + "-" + "updatecache5-" + "setcid" + stat.getCzxid());
      zNode.setStat(stat);
  ...
  public void handleDataChange(String dataPath, Object data) throws Exception
  {
    ...
    try
    {
      ...
      if (zNode != null)
      {
        ...
        changes.add(dataPath + "-" + "handledatachange2" + "-oldcid" + oldStat.getCzxid() + "-newcid" + stat.getCzxid());
  ...
  public void handleDataDeleted(String dataPath) throws Exception
  {
    ...
    try
    {
      ...
      if (zNode != null)
      {
        ...
        changes.add(dataPath + "-" + "handledatadeleted2-" + "setcid" + stat.getCzxid());
        zNode.setStat(stat);
      }
      else
      {
